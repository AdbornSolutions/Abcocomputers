...
const OurTeam = () => {
  return (
    <div className="w-full bg-[#060B14] py-16 flex justify-center px-4">
      <ScrollReveal className="relative w-full max-w-6xl rounded-2xl overflow-hidden">
        <div className="hidden md:block">
          <img src={teamBg} alt="ABCO team" className="object-contain" />
              ...
              <div className="flex -space-x-3">
                {[user1, user2, user3, user4].map((img, i) => (
                  <img
                    ...
                    src={img}
                    alt="team member"
                    className="w-10 h-10 rounded-full border-2 border-white object-cover transition duration-300 hover:-translate-y-1"
                  />
                ))}
              </div>

              <div className="w-10 h-10 rounded-full border border-white flex items-center justify-center text-white text-[18px] premium-glass">
                ↘
              </div>
            </div>
          </div>
        ...
        <div className="md:absolute md:bottom-[20px] md:left-12 md:right-12 p-4 md:p-0">
          <div
            className="inline-block text-white text-[13px] 
            bg-white/10 backdrop-blur-md 
            px-5 py-2 rounded-xl 
            border border-white/30 
            shadow-[0_4px_20px_rgba(0,0,0,0.3)] mb-3 premium-glass"
          >
            Why Choose Us
          </div>
          ...
          <div className="flex flex-col md:flex-row items-start md:items-end justify-between w-full gap-3">
            <div
              className="bg-[#0f172a]/90 text-white px-5 py-4 rounded-xl 
              w-full md:w-[250px] h-auto md:h-[100px] flex items-center border border-white/10 premium-glass"
            >
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto md:ml-auto md:mt-[-20px]">
              <div
                className="bg-[#f3f4f6] text-black px-5 py-5 rounded-[24px] 
                w-full sm:w-[280px] h-auto md:h-[120px] flex flex-col justify-center shadow-md lift-card"
              >
              ...
              >
                <div className="flex items-center gap-3 mb-1">
                  <img src={iconPersonal} alt="" className="w-8 h-8" />
                  <h4 className="text-[18px] md:text-[22px]">
                    Personalization
                  </h4>
                </div>
